	     ...
	     response.setContentType("text/html;charset=utf-8");
	      ...
	      if(qqiu.equals("pageBystuUid")){
	          ...
	          if(str != null && str != "" && str.length() != 0){
	              ...
	              ArrayList<Record> recList=quePageRecordService.pageBystuUid(stuUuid, currentPage, maxResult);
	              int sum=quePageRecordService.pageBystuUid(stuUuid,currentPage,maxResult).size();
//	              int sum = 10;//自己测试
