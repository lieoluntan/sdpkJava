 ...
 * 
 * @author 罗成峰
 * @date 2018-1-9上午11:51:55
 * @version 1.0
 */
public class aaQueKeHeadController extends HttpServlet{
	
	aaQueKeHeadService aaService = new aaQueKeHeadServiceImpl();
	...
	private void qqiuChoice(String qqiu, PaikeRecord paikeRecord) {
		...
		if (list) {
			...
			ArrayList<PaikeRecordView> resultList = aaService.getAllpaike(paikeRecord);
