...
public class MyContrtextController extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (qqiu.equals("list")||qqiu.equals("test")||qqiu.equals("speedList")||qqiu.equals("nameTcnameList")||qqiu.equals("speedMyList")) {
	...
	private void qqiuChoice(String qqiu, String empUuid) {
		...
		if (speedMyList) {
          List<Contrtext> ctextListt = ctextService.getHeadSpeedList(empUuid);
          backResult.setMessage("信息值,成功");
          backResult.setQingqiu("我的合同浏览");
          backResult.setData((ArrayList) ctextListt);
      }
