...
import com.sdpk.query.service.impl.MyConServiceImpl;
import com.sdpk.utility.M_msg;

public class MyConController extends HttpServlet {
	private MyConService myConService = new MyConServiceImpl();
	...
	private void qqiuChoice(String qqiu, String empUuid) {
		...
		if (test) {
			List<Contract> stuList = myConService.getClaId(empUuid);
