 ...
 * 
 * @author xuerenjie
 * @version 创建时间：2018-1-5 下午1:01:00 指定老师的今日课程查询
 */
public class QueryKeMyController extends HttpServlet {
	private QueryKeMyService queryKeMyService = new QueryKeMyServiceImpl();
	...
	private void qqiuChoice(String qqiu, PaikeRecord paikeRecord) {
		...
		if (list) {
			...
			ArrayList<PaikeRecordView> resultList = queryKeMyService
					.getAllPaike(paikeRecord);
