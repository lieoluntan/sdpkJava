...
import com.sdpk.query.dao.impl.QueKeDaoImpl;
 ...
 * 
 * @author 罗成峰
 * @date 2018-1-5下午1:58:38
 * @version 1.0
 */
public class QueKeServiceImpl implements QueKeService{

	private QueKeDao quekedao = new QueKeDaoImpl();
	...
	public ArrayList<PaikeRecordView> getAllpaike(PaikeRecord paikeRecord) {
		...
		ArrayList<PaikeRecordView> prvList = quekedao.getAllpaike(paikeRecord);
